...
const AdminDashboard = () => {
  ...
  if (loading) return <div className="p-8 text-center font-bold text-slate-500">جاري تحميل بيانات لوحة التحكم...</div>;

  return (
    <div className="space-y-8">
      <div className="admin-section">
        <h1 className="text-3xl font-bold text-slate-800 tracking-tight">إحصائيات المستشفى</h1>
        <p className="text-slate-500 mt-1 font-medium text-lg">نظرة عامة على العمليات والمقاييس الحالية للمستشفى.</p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        {/* Staff Management */}
        <div className="xl:col-span-2 bg-white p-8 rounded-3xl border border-slate-100 shadow-sm admin-section">
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm admin-section">
          <h3 className="text-xl font-bold text-slate-800 mb-8">التنبيهات والإشعارات</h3>
          <div className="space-y-8">
            {alerts.map((alert, i) => (
